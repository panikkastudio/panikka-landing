...
This Software is provided by Panikka Pte Ltd and is intended for use as is.
...
For a better experience, while using our Software, we may require you to provide us with certain personally identifiable information. The information that we request will be retained by us and used as described in this privacy policy.
...
- [Google Analytics for Firebase](https://marketingplatform.google.com/about/analytics/terms/us/)
...
If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at apps@panikka.studio.

export default function MDXPage({ children }) {
  return (
    <MdxLayout title="Privacy Policy" tags={[]}>
      {children}
    </MdxLayout>
  );
}
